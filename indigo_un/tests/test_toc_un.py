  ...
  <act contains="singleVersion">
    <meta>
      <identification source="#openbylaws">
        <FRBRWork>
          <FRBRthis value="/un/by-law/cape-town/2002/community-fire-safety/!main"/>
          <FRBRuri value="/un/by-law/cape-town/2002/community-fire-safety"/>
        ...
        <FRBRExpression>
          <FRBRthis value="/un/by-law/cape-town/2002/community-fire-safety/main/eng@"/>
          <FRBRuri value="/un/by-law/cape-town/2002/community-fire-safety/eng@"/>
          <FRBRdate date="2002-02-28" name="Generation"/>
          <FRBRauthor href="#council" as="#author"/>
        ...
        <doc name="schedule">
          <meta>
            <identification source="#slaw">
              <FRBRWork>
                <FRBRthis value="/un/act/1980/01/!schedule1"/>
                <FRBRuri value="/un/act/1980/01"/>
              ...
              <FRBRExpression>
                <FRBRthis value="/un/act/1980/01/eng@/schedule1"/>
                <FRBRuri value="/un/act/1980/01/eng@"/>
                <FRBRdate date="1980-01-01" name="Generation"/>
                <FRBRauthor href="#council" as="#author"/>
                <FRBRlanguage language="eng"/>
              </FRBRExpression>
      ...
      <attachment eId="att_2">
        <doc name="schedule">
          <meta>
            <identification source="#slaw">
              <FRBRWork>
                <FRBRthis value="/un/act/1980/01/!schedule2"/>
                <FRBRuri value="/un/act/1980/01"/>
                <FRBRdate date="1980-01-01" name="Generation"/>
                <FRBRauthor href="#council" as="#author"/>
                <FRBRcountry value="un"/>
              ...
              <FRBRExpression>
                <FRBRthis value="/un/act/1980/01/eng@/schedule2"/>
                <FRBRuri value="/un/act/1980/01/eng@"/>
                <FRBRdate date="1980-01-01" name="Generation"/>
                <FRBRauthor href="#council" as="#author"/>
                <FRBRlanguage language="eng"/>
